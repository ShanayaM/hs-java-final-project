...
public final class GUIGlyph implements GUIMiniGraph{
    ...
    public GUIGlyph(Shape container, SongInterface song, SurveyEnum type){
        ...
        if(SurveyEnum.HOBBY.equals(type)){
            ...
            onePercentYes = getPercentYes(readingHeard, readingLikes);
            ...
            threePercentYes = getPercentYes(sportsHeard, sportsLikes);
            ...
            onePercentYes = getPercentYes(computerScienceHeard, computerScienceLikes);
            one = new Shape(0, 45, onePercentYes, 10, Color.MAGENTA);

            int otherEngineeringHeard = song.getTotal("Other EngineeringHeard");
            int otherEngineeringLikes = song.getTotal("Other EngineeringLikes");
            twoPercentYes = getPercentYes(otherEngineeringHeard, otherEngineeringLikes);
            two = new Shape(0, 55, twoPercentYes, 10, Color.BLUE);

            int mathOrCMDAHeard = song.getTotal("Math or CMDAHeard");
            int mathOrCMDALikes = song.getTotal("Math or CMDALikes");
            threePercentYes = getPercentYes(mathOrCMDAHeard, mathOrCMDALikes);
            three = new Shape(0, 65, threePercentYes, 10, Color.ORANGE);
            ...
            onePercentYes = getPercentYes(northeastHeard, northeastLikes);
            one = new Shape(0, 45, onePercentYes, 10, Color.MAGENTA);

            int southeastHeard = song.getTotal("SoutheastHeard");
            int southeastLikes = song.getTotal("SoutheastLikes");
            twoPercentYes = getPercentYes(southeastHeard, southeastLikes);
            two = new Shape(0, 55, twoPercentYes, 10, Color.BLUE);
            ...
            int outsideOfUnitedStatesHeard = song.getTotal("Outside of United StatesHeard");
            int outsideOfUnitedStatesLikes = song.getTotal("Outside of United StatesLikes");
            fourPercentYes = getPercentYes(outsideOfUnitedStatesHeard, outsideOfUnitedStatesLikes);
            four = new Shape(0, 75, fourPercentYes, 10, Color.GREEN);
        }
    ...
    public  int getPercentYes(int heard, int likes){
